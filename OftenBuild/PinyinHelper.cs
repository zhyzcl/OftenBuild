...
namespace AppPub
{
    ...
    {
        /// <summary>设置或获取字符串编码</summary>
        private static Encoding _StringEncoding = System.Text.Encoding.Default;
        ...
        /// <summary>返回汉字的拼音，如果输入的是英文字符将原样输出，中文标点符号将被忽略</summary>
        /// <param name="chineseChars">汉字字符串</param>
        /// <returns>返回汉字的拼音，如果输入的是英文字符将原样输出，中文标点符号将被忽略</returns>
        public static string GetPinyin(string chineseChars)
        {
            byte[] byteArray = _StringEncoding.GetBytes(chineseChars);
            int byteValue;
        ...
        /// <summary>返回汉字拼音的简写，即每一个汉字的拼音的首字母组成的串，如果输入的是英文字符将原样输出，中文标点符号将被忽略</summary>
        /// <param name="chineseChars">汉字字符串</param>
        /// <returns>返回汉字拼音的简写，即每一个汉字的拼音的首字母组成的串，如果输入的是英文字符将原样输出，中文标点符号将被忽略</returns>
        ...
        /// <summary>返回单个汉字拼音</summary>
        /// <param name="charValue">汉字16进制码</param>
        /// <returns>返回单个汉字拼音</returns>
