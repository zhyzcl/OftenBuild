...
namespace OftenBuild
{
    ...
    public partial class RightMenu : ContextMenuStrip
    {
        ...
        private System.Windows.Forms.ToolStripMenuItem MenuItemSelAllPaset;
        ...
        private void NewRightMenu()
        {
            ...
            this.MenuItemSelAllPaset = new System.Windows.Forms.ToolStripMenuItem();
            ...
            // MenuItemSelAllPaset
            this.MenuItemSelAllPaset.Name = "MenuItemSelAllPaset";
            this.MenuItemSelAllPaset.Size = new System.Drawing.Size(100, 22);
            this.MenuItemSelAllPaset.Text = "全选并粘贴";
        ...
        private void CmsMenu_Opened(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < tstc.Count; i++)
            {
                ...
                else if (cname == "MenuItemPaset" || cname == "MenuItemSelAllPaset")
                {
